	 	...
	 	<div align="left" class="container">
		 	<div align="left" class="row">
		 		<div align="left" class="col-md-6">
		 			<h3 align="left" class="appTitle"><span class="lsf-icon" title="album"><spring:message code="staff.staffManuals.view" /></span></h3>
		 			<br />
		 			<form:form method="POST" modelAttribute="manuals">
		 				<c:if test="${not empty manuals}">
		 					<table width="95%" border="0" cellspacing="5" cellpadding="5">
			 					<c:forEach items="${manuals}" var="manual">
			 						<spring:url value="/staff/manuals/download/${manual.id}/" var="showManual" />
									<tr>
							    		...
							    		<div class="lsf-icon" title="download"><spring:message code="staff.staffManuals.button.download" /></div></button></a></td>
									</tr>
			 					</c:forEach>
		 					</table>
		 				</c:if>
